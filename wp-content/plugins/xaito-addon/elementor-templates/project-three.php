...
<?php if ('layout_three' == $settings['layout_type']) : ?>
	...
	<section class="project-two project-three">
		<div class="project-three__bg-img" style="background-image: url(<?php echo esc_url($settings['layout_three_bg_image']['url']) ?>);"></div>
		<div class="container">
			<div class="row">
				<div class="col-xl-12">
					<?php if (!empty($settings['layout_three_title']) || !empty($settings['layout_three_sub_title'])) : ?>
						<div class="section-title text-center">
							<span class="section-title__tagline"><?php echo wp_kses($settings['layout_three_sub_title'], 'xaito_allowed_tags'); ?></span>

							<<?php echo esc_attr($settings['section_title_three_tag_']) ?> class="section-title__title"><?php echo wp_kses($settings['layout_three_title'], 'xaito_allowed_tags'); ?></<?php echo esc_attr($settings['section_title_three_tag_']) ?>>
						</div>
					<?php endif; ?>
				</div>
			</div>
			<div class="project-two__carousel owl-carousel owl-theme thm-owl__carousel" data-owl-options='<?php echo esc_attr(xaito_get_owl_options($settings)) ?>'>
				<?php foreach ($settings['layout_three_service_items'] as $index => $item) : ?>
