<?php if ('layout_two' == $settings['layout_type']) : ?>
	...
	<div class="xc-cta-two__section wow xcfadeUp">
		<div class="container">
			<div class="xc-cta-two__inner theme-bg p-relative z-1 include-bg" data-background="<?php echo get_template_directory_uri() ?>/assets/img/shapes/cta-shape-2.png">
				<div class="row align-items-center">
					<div class="col-md-8">
						<div class="xc-cta-two__content">
							<div class="xc-cta-two__icon">
								<img src="<?php echo get_template_directory_uri() ?>/assets/img/icons/fun-6.png" alt="">
							</div>
							<div class="xc-cta-two__title-wraper">
								<h3 class="xc-cta-two__title">Level up with AI</h3>
								<p>Deliver personalized experiences with our AI Chatbot.</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="xc-cta-two__btn mb-10">
							<a href="#" class="xc-btn xc-black-btn">Get Started Free</a>
						</div>
					</div>
				</div>
			</div>
	...
	<!-- footer start  -->
	<footer class="xc-footer-one__section style-2 black-footer pt-100 footer-bg">
		<div class="container">
		...
		<div class="xc-footer-one__copyright has-border">
			<div class="container">
				<div class="row">
					<div class="col-12">
						<p class="xc-footer-two__copyright-text text-center">© Copyrights 2023 Xaito All rights
							reserved. </p>
					</div>
				</div>
			</div>
