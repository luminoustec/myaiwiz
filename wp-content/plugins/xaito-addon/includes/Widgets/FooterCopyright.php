...
class FooterCopyright extends \Elementor\Widget_Base
{
    ...
    {
        return __('Footer CopyRight', 'xaito-addon');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'copyright_text',
            [
                'label' => __('Add Right Text', 'xaito-addon'),
                'type' => \Elementor\Controls_Manager::TEXTAREA,
                'default' => __('© 2023 Xaito.com All Rights Reserved', 'xaito-addon')
            ]
        );
        ...
        xaito_typo_and_color_options($this, 'Copyright Text', '{{WRAPPER}} .site-footer__bottom-text', ['layout_one']);
    ...
    protected function render()
    {
        ...
        include xaito_get_template('footer-copyright.php');
    }
}
