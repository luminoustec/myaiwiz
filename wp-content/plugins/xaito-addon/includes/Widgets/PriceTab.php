...
class PriceTab extends \Elementor\Widget_Base
{
	public function get_name()
	{
		return 'xaito-pricetab';
	}

	public function get_title()
	{
		return __('Price Tab', 'xaito-addon');
	}
	...
	protected function register_controls()
	{
		...
		include  xaito_get_elementor_option('price-tab-option.php');
	...
	protected function render()
	{
		...
		include xaito_get_template('price-tab-one.php');
	}
}
