...
class SidebarNav extends \Elementor\Widget_Base
{
	...
	{
		return 'xaito-sidebarnav';
	}

	public function get_title()
	{
		return __('SidebarNav', 'xaito-addon');
	}
	...
	protected function register_controls()
	{
		...
		include  xaito_get_elementor_option('sidebar-nav-menu-one-option.php');
		...
		// list
		xaito_elementor_general_style_options($this, 'List Item', '{{WRAPPER}} .services-single-page__list-box li a', ['layout_one']);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .services-single-page__list-box li a span' => 'color: {{VALUE}};',
				],
				'condition' => [
	...
	protected function render()
	{
		...
		include xaito_get_template('sidebar-nav-menu-one.php');
	}
}
